<template>
    <b-card
        bg-variant="dark"
        text-variant="white"
        title="Learn About BandMixer"
        img-src="https://images.unsplash.com/photo-1510915361894-db8b60106cb1?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80"
        img-width="300"
        img-alt="Card image"
        img-left
        class="m-auto"
