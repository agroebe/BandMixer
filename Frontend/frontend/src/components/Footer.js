            ...
            <footer className="text-center text-light bg-dark">
                <Row>
                    ...
                    <Col>
                        ...
                        <p>
                            For context, this website is created as a part of a semester-long project<br/>
                            for the course CS 309 at Iowa State University. The CY_01 project team consists<br/>
